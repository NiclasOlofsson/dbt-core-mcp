...
async def test_analyze_impact_model(jaffle_shop_server: "DbtCoreMcpServer") -> None:
    ...
    result = await analyze_impact_impl(None, "stg_customers", "model", jaffle_shop_server.state, force_parse=False)
...
async def test_analyze_impact_source(jaffle_shop_server: "DbtCoreMcpServer") -> None:
    ...
    result = await analyze_impact_impl(None, "jaffle_shop.customers", "source", jaffle_shop_server.state, force_parse=False)
...
async def test_analyze_impact_seed(jaffle_shop_server: "DbtCoreMcpServer") -> None:
    ...
    result = await analyze_impact_impl(None, "raw_customers", "seed", jaffle_shop_server.state, force_parse=False)
...
async def test_analyze_impact_multiple_matches(jaffle_shop_server: "DbtCoreMcpServer") -> None:
    ...
    result = await analyze_impact_impl(None, "customers", None, jaffle_shop_server.state, force_parse=False)  # Matches both model and source
...
async def test_analyze_impact_not_found(jaffle_shop_server: "DbtCoreMcpServer") -> None:
    ...
    with pytest.raises(ValueError, match="Impact analysis error"):
        await analyze_impact_impl(None, "nonexistent", "model", jaffle_shop_server.state, force_parse=False)
...
async def test_analyze_impact_message_levels(jaffle_shop_server: "DbtCoreMcpServer") -> None:
    ...
    result = await analyze_impact_impl(None, "customers", "model", jaffle_shop_server.state, force_parse=False)
